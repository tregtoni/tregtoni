...
export const metadata: Metadata = {
  ...
  description: 'Platforma nr.1 shqiptare për njoftime falas. Bli dhe shit makina, imobiliare, elektronikë dhe shumë më tepër. Njoftime nga Shqipëria, Kosova dhe diaspora shqiptare.',
  ...
  openGraph: {
    ...
    description: 'Platforma nr.1 shqiptare për njoftime falas. Bli dhe shit makina, imobiliare, elektronikë dhe shumë më tepër.',
    images: [{ url: OG_IMAGE, width: 1200, height: 630, alt: 'Tregtoni.com' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Tregtoni.com - Blini. Shitni. Tregtoni.',
    description: 'Platforma nr.1 shqiptare për njoftime falas.',
    images: [OG_IMAGE],
  },
  robots: {
    index: true,
