    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            {/* Header */}
            <div style={{ background: '#E24B4A', padding: '18px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
            ...
            {state.success ? (
              <div style={{ padding: '40px 24px', textAlign: 'center' }}>
                ...
                <button
                  onClick={handleClose}
                  style={{ background: '#E24B4A', color: '#fff', border: 'none', borderRadius: '8px', padding: '10px 24px', fontSize: '14px', fontWeight: '600', cursor: 'pointer' }}
                >
                  Mbyll
                </button>
              </div>
